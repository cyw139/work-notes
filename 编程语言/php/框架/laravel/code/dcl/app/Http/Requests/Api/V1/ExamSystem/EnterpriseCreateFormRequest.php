...
class EnterpriseCreateFormRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'credit_code' => 'required|string|min:1|max:100|unique:App\Models\ExamSystem\Enterprise,credit_code', // 统一社会信用代码
            ...
            'registration_number' => 'required|string|min:1|max:30|unique:App\Models\ExamSystem\Enterprise,registration_number', // 工商注册号
