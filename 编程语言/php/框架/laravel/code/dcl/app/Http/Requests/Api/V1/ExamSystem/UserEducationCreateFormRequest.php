...
class UserEducationCreateFormRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'user_id' => 'bail|required|integer|min:1|exists:App\Models\ExamSystem\User,id',
            'diploma_number' => 'required|string|min:6|max:50|unique:App\Models\ExamSystem\UserEducation,diploma_number',
