...
class CategorySecondSheetImport implements ToCollection
{
    protected $userId;
    protected $nameIndexMap = [];
    protected $tree = [];
    protected $importRows = [];
    protected $type = Category::ENTERPRISE_TYPE;
...
//        Category::fixTree();
    ...
    private function dataFormatter($row) {
        ...
        $nodeNames[] = $row[$this->nameIndexMap['企业类型 - 1']];
        $nodeNames[] = $row[$this->nameIndexMap['企业类型 - 2']];
